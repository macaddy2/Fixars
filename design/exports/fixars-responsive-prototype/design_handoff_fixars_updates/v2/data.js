...
const STATE = {
  ...
  wallet: 284500,
  points: 1240,
  user: { name: 'Ade Obi', initials: 'AO', fcs: 742, loc: 'Lagos' },
  ...
  talents: [
    { id: 't1', name: 'Tolu Okafor', role: 'Full-stack engineer', cat: 'Engineering', loc: 'Lagos', rate: '₦12k/hr', fcs: 742, skills: ['React','Postgres','Mobile money'], tier: 'proven', projects: 14, status: 'available', last: '2h ago' },
    { id: 't2', name: 'Kemi Adesanya', role: 'Product designer', cat: 'Design', loc: 'Abuja', rate: '₦9k/hr', fcs: 689, skills: ['Figma','Research','Systems'], tier: 'proven', projects: 22, status: 'busy', last: '14m ago' },
    { id: 't3', name: 'Bisi Eze', role: 'Mobile engineer', cat: 'Engineering', loc: 'Lagos', rate: '₦14k/hr', fcs: 718, skills: ['Flutter','Swift','Kotlin'], tier: 'assessed', projects: 9, status: 'available', last: '1h ago' },
    { id: 't4', name: 'Femi Akande', role: 'Data analyst', cat: 'Data', loc: 'Remote', rate: '₦8k/hr', fcs: 612, skills: ['SQL','dbt','Python'], tier: 'self', projects: 5, status: 'off', last: '2d ago' },
    { id: 't5', name: 'Ngozi Udo', role: 'Operations lead', cat: 'Operations', loc: 'Port Harcourt', rate: '₦10k/hr', fcs: 701, skills: ['Logistics','Vendor mgmt','Field ops'], tier: 'peer', projects: 11, status: 'busy', last: '42m ago' }
  ],
